...
The following are considered security vulnerabilities in gatekeeper:
...
- **Information disclosure**: gatekeeper leaking sensitive data (command contents, file paths) beyond the audit log
...
- Issues requiring local root/admin access (gatekeeper does not defend against privileged attackers)
